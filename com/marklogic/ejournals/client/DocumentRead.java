...
import com.marklogic.ejournals.client.Util;
import com.marklogic.ejournals.client.Util.ExampleProperties;
...
public class DocumentRead {
	...
	public static void run(ExampleProperties props)
		...
		runShortcut(client, "/example/flipper.xml");
	...
	public static void runShortcut(DatabaseClient client , String docId) throws IOException {
	...
	public static Document documentRead(DatabaseClient client , String docId)
			throws IOException, XPathExpressionException {
		// create a manager for XML documents
		XMLDocumentManager docMgr = client.newXMLDocumentManager();
	...
	public static void documentWrite(DatabaseClient client , String filename) throws IOException {
		...
		System.out.println("(Strong Typed) Wrote /LOGS/"+filename+" content");
		}
		catch (Exception e)
		{
			e.printStackTrace();
