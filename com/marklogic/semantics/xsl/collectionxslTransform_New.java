...
public class collectionxslTransform_New {
	...
	public static void main(String[] args) throws Exception {
		...
		for (int collectionId = 11; collectionId <= 12; collectionId++) { //300
			String createinputXML = "data/stylesheet/input_copy/temp_collectionNode.xml";
			...
			if (c_name.length() > 5) {
				...
				String stylesheet = "data/stylesheet/input_copy/collectionrdfTransformer.xsl";  
				String destfile = "data/stylesheet/output_copy/collection/2temp" + c_name.replace("/", "_") + "_to_rdf.rdf";  
				XSLtransform_collection(collectionId, c_name,createinputXML,stylesheet,destfile); 
					
				stylesheet = "data/stylesheet/input_copy/coveragerdfTransformer.xsl";  
				destfile = "data/stylesheet/output_copy/coverage/2temp" + c_name.replace("/", "_") + "_to_rdf.rdf";  
				XSLtransform_collection(collectionId, c_name,createinputXML,stylesheet,destfile);
				 
				stylesheet = "data/stylesheet/input_copy/eventrdfTransformer.xsl";  
				destfile = "data/stylesheet/output_copy/event/2temp" + c_name.replace("/", "_") + "_to_rdf.rdf";  
				XSLtransform_collection(collectionId, c_name,createinputXML,stylesheet,destfile);

				stylesheet = "data/stylesheet/input_copy/licenserdfTransformer.xsl";  
				destfile = "data/stylesheet/output_copy/license/2temp" + c_name.replace("/", "_") + "_to_rdf.rdf";  
				XSLtransform(c_name,createinputXML,stylesheet,destfile);
 
				stylesheet = "data/stylesheet/input_copy/portfoliordfTransformer.xsl";  
				destfile = "data/stylesheet/output_copy/portfolio/2temp" + c_name.replace("/", "_") + "_to_rdf.rdf";  
				XSLtransform(c_name,createinputXML,stylesheet,destfile);
		...
		String stylesheet = "data/stylesheet/input_copy/journalrdfTransformer.xsl"; // change here
		String destfile = "data/stylesheet/output_copy/journal/2temp_issn_to_rdf.rdf"; // change
	...
	public static void getIssnNode( )
		...
		String str = rs.asString();
		BufferedWriter writer = new BufferedWriter(new FileWriter("data/stylesheet/input_copy/temp_issnNode.xml"));
		writer.write(str);
	...
	public static void XSLtransform(String c_name , String createinputXML , String stylesheet , String destfile ) throws Exception {
		...
		//String stylesheet = "data/stylesheet/input_copy/portfoliordfTransformer.xsl"; // change here
		//String destfile = "data/stylesheet/output_copy/portfolio/temp" + c_name.replace("/", "_") + "_to_rdf.rdf"; // change
		// here
		...
		// jc System.setProperty("javax.xml.transform.TransformerFactory", "net.sf.saxon.TransformerFactoryImpl");
	...
	public static void XSLISSNtransform( String c_name , String stylesheet , String destfile) throws Exception {
		...
		String tempfile = "data/stylesheet/input_copy/temp_issnNode.xml";
