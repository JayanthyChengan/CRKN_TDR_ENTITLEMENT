...
public class JsonToTriples {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            // Extract triples
            extractTriples(rootNode, "https://ror.org/03dbr7087");
    ...
    public static void extractTriples(JsonNode node, String subject) {
        ...
        while (fieldNames.hasNext()) {
            ...
            if (valueNode.isObject()) {
                ...
                extractTriples(valueNode, subject + "/" + predicate);
            } else if (valueNode.isArray()) {
                // If the value is an array, iterate over the elements
                for (JsonNode arrayElement : valueNode) {
                    extractTriples(arrayElement, subject + "/" + predicate);
                }
            } else {
                // If the value is a simple type, print the triple
                String object = valueNode.asText();
                System.out.println(subject + " " + "http://scholarsportal.info/ontologies/core/" +predicate + " " + object);
            }
        }
    }
}