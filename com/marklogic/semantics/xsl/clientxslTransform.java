...
public class clientxslTransform {
	...
	public static void main(String[] args) throws Exception {
		 ...
		 //  THIS PROGRAM IS NOT USED , INSTEAD USED CREATECLIENTTRIPLES.JAVA
		
		
		
		
		for (int clientCount = 1; clientCount <= 350; clientCount++) {
			String createinputXML = "data/stylesheet/input/temp_clientNode.xml";
			getCollectionNode(createinputXML , clientCount);

			c_name = getClientName(clientCount); 
			

			if (c_name.length() > 1) {
				
				String stylesheet = "data/stylesheet/input/clientrdfTransformer.xsl";  
				String destfile = "data/stylesheet/output/client/temp" + c_name.replace("/", "_") + "_to_rdf.rdf";  
	...
	public static String getClientName(int clientCount)
			throws URISyntaxException, XccConfigException, RequestException, IOException {
		...
		String query = "let $doc := doc('/LOGS/client.xml')   return  $doc//library[" + clientCount + "]/@name  ";
